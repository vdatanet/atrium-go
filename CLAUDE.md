...
| [reference-fixture-reading.json](docs/compatibility/reference-fixture-reading.json) | The reference's recorded reading of the fixture tree. Compared against Atrium's own scan **as a declared inequality**: 47 known differences, where an undeclared one fails *and a declared one that has gone away fails too*. | — |
